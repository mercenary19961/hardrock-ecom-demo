...
export function Select({ value, onChange, options, placeholder = 'Select...', className, id, name, label, dropdownPosition = 'bottom', size = 'default' }: SelectProps) {
    ...
    return (
        <div ref={containerRef} className={cn('relative', className)}>
            ...
            <button
                ...
                className={cn(
                    'w-full flex items-center justify-between gap-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 dark:text-white text-left',
            ...
            >
                ...
                <ChevronDown className={cn(
                    'text-gray-500 dark:text-gray-400 flex-shrink-0 transition-transform',
